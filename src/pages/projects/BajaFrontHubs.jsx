    ...
    >
      <ScrollReveal>
        <div className="project-section">
          <h3>Overview</h3>
          <p>
            Front hub design for the 25'–26' Longhorn Baja vehicle, manufactured using laminated
            manufacturing techniques. The front hubs must accommodate steering geometry and meet the
            hardpoint requirements defined by the master sketch.
          </p>
        </div>
      </ScrollReveal>
